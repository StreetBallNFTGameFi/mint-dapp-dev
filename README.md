...
Designed to easy customize, and deploy their own mint dapp to a custom domain, ultra fast.

An on-chain Solana program (or smart contract) for managing fair mint. Fair mints:
